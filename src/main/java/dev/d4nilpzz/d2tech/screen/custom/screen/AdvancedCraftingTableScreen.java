...
public class AdvancedCraftingTableScreen extends AbstractContainerScreen<AdvancedCraftingTableMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/advanced_crafting_table.png");

    public AdvancedCraftingTableScreen(AdvancedCraftingTableMenu menu, Inventory playerInventory, Component title) {
