...
public class DecodeComputerScreen extends AbstractContainerScreen<DecodeComputerMenu> {
    ...
    public void render(@NotNull GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        ScreenUtils.drawAscii(pGuiGraphics, this.leftPos + 47,
                this.topPos + 15);

        ScreenUtils.drawAscii(pGuiGraphics, this.leftPos + 63,
                this.topPos + 15);

        ScreenUtils.setTooltip(ScreenUtils.getButtonBounds(this.leftPos + 63, this.topPos + 52), pMouseX,
                pMouseY, pGuiGraphics, "Create Recipe");
    }
}
